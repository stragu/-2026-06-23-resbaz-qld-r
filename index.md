...
venue: "ResBaz QLD 2026 - R"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Room E558, QUT Kelvin Grove, Meanjin (Brisbane)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
instructor: ["Catherine Kim", "Riad Akhundov", "Caitie Kuempel"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Senn Oon", "Arwen Nugteren", "Joanna Salerno", "Vicki Thomson", "Justin Scott", "Danny Meloncelli", "Stéphane Guillou"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p>
Welcome to the Carpentries R workshop at <a href="https://resbaz.github.io/resbaz2026qld">ResBaz QLD 2026</a>! We will follow the "<a href="https://swcarpentry.github.io/r-novice-gapminder/">R for Reproducible Scientific Analysis</a>" curriculum.
</p>
<p>
